...
doc {
	title "CreateAutoScalingGroupRemovalInstanceRule"
	...
	rest {
		request {
			url "POST /v1/autoscaling/rules/removal-instance"

			header (Authorization: 'OAuth the-session-uuid')

			clz APICreateAutoScalingGroupRemovalInstanceRuleMsg.class
