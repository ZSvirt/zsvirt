...
public class APIChangeVmImageEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APIChangeVmImageEvent() {
    }

    public APIChangeVmImageEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIChangeVmImageEvent __example__() {
        APIChangeVmImageEvent evt = new APIChangeVmImageEvent();
