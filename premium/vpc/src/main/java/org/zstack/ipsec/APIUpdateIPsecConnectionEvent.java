...
public class APIUpdateIPsecConnectionEvent extends APIEvent {

    private IPsecConnectionInventory inventory;

    public APIUpdateIPsecConnectionEvent() {
    }

    public APIUpdateIPsecConnectionEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIUpdateIPsecConnectionEvent __example__() {
        APIUpdateIPsecConnectionEvent event = new APIUpdateIPsecConnectionEvent();
