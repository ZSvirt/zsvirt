...
public class APIUpdateResourceStackEvent extends APIEvent {
    ...
    public APIUpdateResourceStackEvent() {
    }

    public APIUpdateResourceStackEvent(String apiId) {
        super(apiId);
    }

    public static APIUpdateResourceStackEvent __example__() {
        APIUpdateResourceStackEvent event = new APIUpdateResourceStackEvent();
