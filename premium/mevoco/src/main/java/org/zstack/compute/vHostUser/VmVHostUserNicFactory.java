...
public class VmVHostUserNicFactory implements VmInstanceNicFactory {
    private static final CLogger logger = Utils.getLogger(VmVHostUserNicFactory.class);
    private static final VmNicType type = new VmNicType(VmOvsNicConstant.ACCEL_TYPE_VHOST_USER_SPACE);
