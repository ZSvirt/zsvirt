...
import org.zstack.billing.spendingcalculator.volume.root.RootVolumeSpendingInventory;
 ...
 */
public class RootVolumeBillingSpendingCalculator implements BillingSpendingCalculator {
    ...
    public Spending calculate(SpendingStruct param) {
        return new BillingSpendingCalculatorTemplate() {
            ...
            protected SpendingDetails make(BillingVO billingVO) {
                RootVolumeBillingVO volumeBillingVO = (RootVolumeBillingVO) billingVO;

                RootVolumeSpendingInventory inventory = new RootVolumeSpendingInventory();
                ...
                RootVolumeSpending spendingDetails = new RootVolumeSpending();
            ...
            protected void merge(SpendingDetails source, SpendingDetails target) {
                RootVolumeSpending sourceSpending = (RootVolumeSpending) source;
                RootVolumeSpending targetSpending = (RootVolumeSpending) target;
            ...
            protected int getBillingCount() {
                return this.getBillingVOCount(RootVolumeBillingVO.class);
            }

            @Override
            protected List<BillingVO> getBillingVOS(int offset) {
                return this.getBillingVOS(RootVolumeBillingVO.class, offset);
            }
        }.calculate(param);
    }
}
