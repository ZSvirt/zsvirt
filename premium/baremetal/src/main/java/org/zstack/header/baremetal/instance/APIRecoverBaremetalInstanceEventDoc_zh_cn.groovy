...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.instance.APIRecoverBaremetalInstanceEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.instance.APIRecoverBaremetalInstanceEvent.inventory"
		desc "裸机实例清单"
