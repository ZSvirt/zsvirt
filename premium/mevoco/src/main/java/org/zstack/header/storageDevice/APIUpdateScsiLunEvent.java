...
public class APIUpdateScsiLunEvent extends APIEvent {
    ...
    public APIUpdateScsiLunEvent(String apiId) {
        super(apiId);
    }

    public APIUpdateScsiLunEvent() {
        super(null);
    }

    public static APIUpdateScsiLunEvent __example__() {
        APIUpdateScsiLunEvent event = new APIUpdateScsiLunEvent();
