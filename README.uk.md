...
#### 2-ге півріччя 2026 року

| Область | Заплановані роботи |
|---|---|
| **Безпека** | Додати шифрування дисків ВМ<br>Додати шифрування міграції ВМ |
| **DRS і міграція ВМ** | Додати гнучкіші варіанти міграції:<br>• Можливість переносити диски окремо<br>• Підтримка гарячої та холодної міграції для сценарію SAN-to-SAN |
| **ZMigrate** | **ZMigrate 2.1**:<br>• Додати попередню перевірку для зниження ризиків складної міграції<br>• Простіші та розумніші сценарії міграції |
| **Експлуатація** | Додати метрики часу CPU Ready ВМ, затримки читання й запису дисків ВМ, частки втрачених мережевих пакетів і часу CPU Ready хоста<br>Підтримати докладніші рівні журналювання під час пересилання до зовнішнього syslog<br>Додати моніторинг пристроїв NVMe і FC, включно з IOPS і затримкою<br>Вбудувати драйвери QXL у VMTools для кращого відображення та роздільності консолі ВМ |
| **Інвентаризація** | Розширити реєстрацію сховищ і ВМ на реєстрацію в межах одного сайту |
