...
public class APIUpdateBaremetalInstanceEvent extends APIEvent {
    private BaremetalInstanceInventory inventory;

    public APIUpdateBaremetalInstanceEvent() {
    }

    public APIUpdateBaremetalInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIUpdateBaremetalInstanceEvent __example__() {
        APIUpdateBaremetalInstanceEvent event = new APIUpdateBaremetalInstanceEvent();
