...
<div align="center">
  ...
  <p align="center">
    <a
      ...
      rel="noopener noreferrer"><img
        ...
        alt="ZSvirt Java au quotidien – Trendshift"
        width="250"
        height="55"
      /></a> <a href="https://trendshift.io/repositories/156451?utm_source=trendshift-badge&amp;utm_medium=badge&amp;utm_campaign=badge-trendshift-156451"
       ...
       rel="noopener noreferrer"><img
        ...
        alt="ZSvirt Java hebdomadaire – Trendshift"
        width="250"
        height="55"
      /></a>&nbsp;&nbsp;
  </p>
  ...
  <p align="center">
    <a href="https://zsvirt.io">
      <img
        src="https://img.shields.io/badge/Site%20web-0F62FE?style=flat-square&logo=googlechrome&logoColor=white"
        alt="Site web"
      >
    </a>
    <a href="https://zsvirt.io/en/docs">
      <img
        src="https://img.shields.io/badge/Documentation-7C3AED?style=flat-square&logo=readthedocs&logoColor=white"
        alt="Documentation"
      >
    </a>
    <a href="https://demo.zsvirt.io/">
      <img
        src="https://img.shields.io/badge/D%C3%A9mo%20en%20ligne-16A34A?style=flat-square&logo=internetcomputer&logoColor=white"
        alt="Démo en ligne"
      >
    </a>
    <a href="https://zsvirt.io/download">
      <img
        src="https://img.shields.io/badge/T%C3%A9l%C3%A9chargement-F97316?style=flat-square&logo=data:image/svg%2Bxml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%2BPHBhdGggZmlsbD0iI2ZmZiIgZD0iTTUgMjBoMTR2LTJINXYyem0xNC05aC00VjNIOXY4SDVsNyA3IDctN3oiLz48L3N2Zz4%3D"
        alt="Téléchargement"
      >
    </a>
  </p>
  ...
  <p align="center">
    <a href="https://raw.githubusercontent.com/ZSvirt/.github/main/assets/zsvirt-inventory.png">
      <img
        ...
        alt="Inventaire de l’infrastructure ZSvirt"
        width="100%"
      >
    </a>
  </p>
  ...
  <p align="center">
    <a href="https://raw.githubusercontent.com/ZSvirt/.github/main/assets/zsvirt-migration-management.png">
      <img
        ...
        alt="Gestion des migrations ZSvirt"
        width="100%"
      >
    </a>
  </p>
...
<p align="center">
  <a href="https://zsvirt.io/vmware-alternative/">
    <img
      ...
      alt="Migrer de VMware vers ZSvirt"
      width="100%"
    >
  </a>
</p>
...
🚀 [Démarrage rapide](https://zsvirt.io/en/docs/quick-start)<br>
...
<p align="center">
  <img
    ...
    alt="Clients et partenaires mondiaux de ZSvirt"
    width="100%"
  >
</p>
...
<p align="center">
  <img
    ...
    alt="Comparaison de Proxmox VE et ZSvirt"
    width="100%"
  >
</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p>Découvrez les fonctions, cas d’usage, actualités et ressources communautaires de ZSvirt.</p>
      <a href="https://zsvirt.io"><strong>Visiter le site →</strong></a>
    </td>
    <td width="50%">
      <h3>▶️ Vidéos</h3>
      <p>Regardez la présentation de ZSvirt et découvrez ses principales fonctions.</p>
  ...
  <tr>
    <td width="50%">
      <h3>📝 Blog</h3>
      <p>Retrouvez les nouveautés des versions, récits d’ingénierie et analyses sur la virtualisation.</p>
      <a href="https://zsvirt.io/blog"><strong>Lire le blog →</strong></a>
    </td>
    <td width="50%">
      <h3>💬 GitHub Discussions</h3>
      <p>Posez des questions, partagez vos idées et échangez avec la communauté ZSvirt.</p>
  ...
  <tr>
    <td width="50%">
      <h3>▶️ YouTube</h3>
      <p>Suivez la chaîne ZSvirt pour les démonstrations, tutoriels et mises à jour produit.</p>
      <a href="https://youtube.com/@ZSvirt"><strong>Suivre sur YouTube →</strong></a>
    </td>
    <td width="50%">
      <h3>💼 LinkedIn</h3>
      <p>Suivez ZSvirt pour les actualités du projet, temps forts communautaires et analyses du secteur.</p>
  ...
  <tr>
    <td width="50%">
      <h3>𝕏 X</h3>
      <p>Recevez les dernières annonces et actualités de la communauté ZSvirt.</p>
      <a href="https://x.com/ZSvirt"><strong>Suivre sur X →</strong></a>
    </td>
    <td width="50%">
      <h3>🎮 Discord</h3>
      <p>Rejoignez la communauté ZSvirt pour poser vos questions, partager vos idées et rencontrer d’autres utilisateurs.</p>
