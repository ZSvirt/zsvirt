...
public class XDragonRealizeL2NoVlanNetworkBackend implements L2NetworkRealizationExtensionPoint {
    @Autowired
    ...
    public void realize(L2NetworkInventory l2Network, String hostUuid, boolean noStatusCheck, Completion completion) {
        kvmL2extp.realize(l2Network, hostUuid, noStatusCheck, completion);
    }
