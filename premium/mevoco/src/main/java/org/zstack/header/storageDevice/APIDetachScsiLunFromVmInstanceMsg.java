...
@RestRequest(
        ...
        responseClass = APIDetachScsiLunFromVmInstanceEvent.class
)
public class APIDetachScsiLunFromVmInstanceMsg extends APIMessage implements APIMultiAuditor {
    ...
    public static APIDetachScsiLunFromVmInstanceMsg __example__() {
        APIDetachScsiLunFromVmInstanceMsg msg = new APIDetachScsiLunFromVmInstanceMsg();
        msg.setUuid(uuid());
    ...
    public List<APIAuditor.Result> multiAudit(APIMessage msg, APIEvent rsp) {
        APIDetachScsiLunFromVmInstanceMsg amsg = (APIDetachScsiLunFromVmInstanceMsg) msg;
