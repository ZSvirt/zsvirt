...
class DingTalkTextTemplate extends AbstractTextTemplate implements TextTemplate {
...
- 资源 IP: ${EVENT_RESOURCE_IP}
- 集群 UUID: ${EVENT_RESOURCE_CLUSTER_UUID}
- 集群名称: ${EVENT_RESOURCE_CLUSTER_NAME}
'''
    ...
    SNSTopicMessage createMessage(SNSTextTemplateInventory template, AlarmAction.TakeAlarmActionParam actionParam, String locale) {
        ...
        message.metadata = JSONObjectUtil.rehashObject(new DingTalkMessageMetadata(
