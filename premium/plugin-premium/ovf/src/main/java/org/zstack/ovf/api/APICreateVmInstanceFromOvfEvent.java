...
public class APICreateVmInstanceFromOvfEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APICreateVmInstanceFromOvfEvent() {
        super(null);
    }

    public APICreateVmInstanceFromOvfEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APICreateVmInstanceFromOvfEvent __example__() {
        APICreateVmInstanceFromOvfEvent evt = new APICreateVmInstanceFromOvfEvent();
        ...
        vm.setMemorySize(SizeUnit.GIGABYTE.toByte(4));
