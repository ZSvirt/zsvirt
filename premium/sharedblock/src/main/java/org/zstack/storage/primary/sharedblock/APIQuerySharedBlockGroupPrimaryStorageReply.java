...
public class APIQuerySharedBlockGroupPrimaryStorageReply extends APIQueryReply {
    private List<SharedBlockGroupPrimaryStorageInventory> inventories;

    public List<SharedBlockGroupPrimaryStorageInventory> getInventories() {
        return inventories;
    }

    public void setInventories(List<SharedBlockGroupPrimaryStorageInventory> inventories) {
        this.inventories = inventories;
    }

    public static APIQuerySharedBlockGroupPrimaryStorageReply __example__() {
        APIQuerySharedBlockGroupPrimaryStorageReply reply = new APIQuerySharedBlockGroupPrimaryStorageReply();
