...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.instance.APIUpdateBaremetalInstanceEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.instance.APIUpdateBaremetalInstanceEvent.inventory"
		desc "裸机实例清单"
