...
public class APIRecoverVmBackupFromImageStoreBackupStorageEvent extends APIEvent {
    private List<VolumeBackupInventory> inventories;

    public APIRecoverVmBackupFromImageStoreBackupStorageEvent(String apiId) {
        super(apiId);
    }

    public APIRecoverVmBackupFromImageStoreBackupStorageEvent() {
        super(null);
    }
    ...
    public static APIRecoverVmBackupFromImageStoreBackupStorageEvent __example__() {
        APIRecoverVmBackupFromImageStoreBackupStorageEvent event = new APIRecoverVmBackupFromImageStoreBackupStorageEvent();
