...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.instance.APIRebootBaremetalInstanceEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.instance.APIRebootBaremetalInstanceEvent.inventory"
		desc "裸机实例清单"
