...
doc {
	...
	ref {
		name "inventories"
		path "org.zstack.sns.platform.feishu.APIQuerySNSFeiShuAtPersonReply.inventories"
		desc "null"
		type "List"
		since "zsv 4.2.0"
	...
	ref {
		name "error"
		path "org.zstack.sns.platform.feishu.APIQuerySNSFeiShuAtPersonReply.error"
