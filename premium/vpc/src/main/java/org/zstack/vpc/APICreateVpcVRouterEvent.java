...
public class APICreateVpcVRouterEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APICreateVpcVRouterEvent() {
        super(null);
    }

    public APICreateVpcVRouterEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APICreateVpcVRouterEvent __example__() {
        APICreateVpcVRouterEvent event = new APICreateVpcVRouterEvent();
        ...
        vm.setName("TestVPC");
        vm.setDescription("this is a vpc for test");
        vm.setUuid(uuid());
        ...
        vm.setDefaultL3NetworkUuid(uuid());
        vm.setHostUuid(uuid());
        ...
        vm.setZoneUuid(uuid());
        vm.setStatus(ApplianceVmStatus.Connected.toString());
        vm.setAgentPort(VirtualRouterGlobalProperty.AGENT_PORT);
