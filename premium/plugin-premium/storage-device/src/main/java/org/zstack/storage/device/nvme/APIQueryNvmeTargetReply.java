...
public class APIQueryNvmeTargetReply extends APIQueryReply {
    ...
    public static APIQueryNvmeTargetReply __example__() {
        APIQueryNvmeTargetReply reply = new APIQueryNvmeTargetReply();
        ...
        reply.setInventories(Collections.singletonList(nvmeTargetInv1));
        return reply;
    }
}
