...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.instance.APICreateBaremetalInstanceEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.instance.APICreateBaremetalInstanceEvent.inventory"
		desc "裸机实例清单"
