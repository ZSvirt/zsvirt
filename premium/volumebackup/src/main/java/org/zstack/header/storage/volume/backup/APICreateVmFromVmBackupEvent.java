...
public class APICreateVmFromVmBackupEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APICreateVmFromVmBackupEvent(String apiId) {
        super(apiId);
    }

    public APICreateVmFromVmBackupEvent() {
        super(null);
    }
    ...
    public static APICreateVmFromVmBackupEvent __example__() {
        APICreateVmFromVmBackupEvent evt = new APICreateVmFromVmBackupEvent();
