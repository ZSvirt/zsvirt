...
public class APIRebootBaremetalInstanceEvent extends APIEvent {
    private BaremetalInstanceInventory inventory;

    public APIRebootBaremetalInstanceEvent() {
    }

    public APIRebootBaremetalInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIRebootBaremetalInstanceEvent __example__() {
        APIRebootBaremetalInstanceEvent event = new APIRebootBaremetalInstanceEvent();
        ...
        bm.setState(BaremetalInstanceState.Rebooting.toString());
