...
public class SharedBlockDeleteVolumeGC extends TimeBasedGarbageCollector {
    private static final CLogger logger = Utils.getLogger(SharedBlockDeleteVolumeGC.class);
    ...
    protected void triggerNow(GCCompletion completion) {
        ...
        logger.debug(String.format("running sharedblock gc volume[uuid:%s, installPath:%s]",
