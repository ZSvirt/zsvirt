...
public class APIResizeRootVolumeEvent extends APIEvent {
    ...
    public APIResizeRootVolumeEvent() {
        super(null);
    }

    public APIResizeRootVolumeEvent(String apiId) {
        super(apiId);
    }


    public static APIResizeRootVolumeEvent __example__() {
        APIResizeRootVolumeEvent event = new APIResizeRootVolumeEvent();
