...
@RestRequest(
        path = "/hosts/bondings/{uuid}/attach",
        isAction = true,
        method = HttpMethod.PUT,
        responseClass = APIAttachNicToBondingEvent.class
)
public class APIAttachNicToBondingMsg extends APIMessage implements BondingMessage {
    /**
    ...
    public static APIAttachNicToBondingMsg __example__() {
        APIAttachNicToBondingMsg msg = new APIAttachNicToBondingMsg();
        msg.setUuid(uuid());
