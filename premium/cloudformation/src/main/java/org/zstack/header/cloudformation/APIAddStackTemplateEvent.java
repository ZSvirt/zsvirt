...
public class APIAddStackTemplateEvent extends APIEvent {
    ...
    public APIAddStackTemplateEvent() {
    }

    public APIAddStackTemplateEvent(String apiId) {
        super(apiId);
    }

    public static APIAddStackTemplateEvent __example__() {
        APIAddStackTemplateEvent event = new APIAddStackTemplateEvent();
