...
public class APIRestartResourceStackEvent extends APIEvent {
    ...
    public APIRestartResourceStackEvent() {
    }

    public APIRestartResourceStackEvent(String apiId) {
        super(apiId);
    }

    public static APIRestartResourceStackEvent __example__() {
        APIRestartResourceStackEvent event = new APIRestartResourceStackEvent();
