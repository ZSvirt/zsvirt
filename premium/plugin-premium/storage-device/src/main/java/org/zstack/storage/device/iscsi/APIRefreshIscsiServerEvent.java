...
public class APIRefreshIscsiServerEvent extends APIEvent {
    ...
    public APIRefreshIscsiServerEvent(String apiId) {
        super(apiId);
    }

    public APIRefreshIscsiServerEvent() {
        super(null);
    }

    public static APIRefreshIscsiServerEvent __example__() {
        APIRefreshIscsiServerEvent event = new APIRefreshIscsiServerEvent();
