...
/**
 *  Create by lining at 2018/11/16
 */
@RestRequest(
        path = "/zwatch/alarm-histories/actions",
        method = HttpMethod.PUT,
        isAction = true,
        responseClass = APIUpdateAlarmDataEvent.class
)
public class APIUpdateAlarmDataMsg extends APIMessage {
    ...
    public static APIUpdateAlarmDataMsg __example__() {
        APIUpdateAlarmDataMsg msg = new APIUpdateAlarmDataMsg();
        return msg;
    }
