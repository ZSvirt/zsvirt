...
@RestRequest(
        ...
        responseClass = APICreateDataVolumeTemplateFromVolumeBackupEvent.class
)
@DefaultTimeout(timeunit = TimeUnit.HOURS, value = 72)
public class APICreateDataVolumeTemplateFromVolumeBackupMsg extends APICreateMessage implements CreateVolumeTemplateFromBackupMessage, APIAuditor {
    ...
    public Result audit(APIMessage msg, APIEvent rsp) {
        return new Result(rsp.isSuccess() ? ((APICreateDataVolumeTemplateFromVolumeBackupEvent)rsp).getInventory().getUuid() : "", ImageVO.class);
    }

    public static APICreateDataVolumeTemplateFromVolumeBackupMsg __example__() {
        APICreateDataVolumeTemplateFromVolumeBackupMsg msg = new APICreateDataVolumeTemplateFromVolumeBackupMsg();

        msg.setName("template");
        msg.setDescription("data template from volume backup");
