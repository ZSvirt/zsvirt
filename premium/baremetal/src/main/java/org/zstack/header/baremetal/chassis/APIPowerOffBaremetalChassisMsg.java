...
@RestRequest(
        ...
        responseClass = APIPowerOffBaremetalChassisEvent.class
)
public class APIPowerOffBaremetalChassisMsg extends APIMessage {
    ...
    public static APIPowerOffBaremetalChassisMsg __example__() {
        APIPowerOffBaremetalChassisMsg msg = new APIPowerOffBaremetalChassisMsg();
