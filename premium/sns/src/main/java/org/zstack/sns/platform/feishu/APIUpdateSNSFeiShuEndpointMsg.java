...
@RestRequest(
        path = "/sns/application-endpoints/feishu/{uuid}/actions",
        method = HttpMethod.PUT,
        responseClass = APIUpdateSNSApplicationEndpointEvent.class,
        isAction = true
)
public class APIUpdateSNSFeiShuEndpointMsg extends APIUpdateSNSApplicationEndpointMsg {
    ...
    public static APIUpdateSNSApplicationEndpointMsg __example__() {
        APIUpdateSNSFeiShuEndpointMsg msg = new APIUpdateSNSFeiShuEndpointMsg();
        msg.setUuid(uuid());
