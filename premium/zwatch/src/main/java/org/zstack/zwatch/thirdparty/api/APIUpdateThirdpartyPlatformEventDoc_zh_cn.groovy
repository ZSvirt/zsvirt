...
doc {
	...
	ref {
		name "error"
		path "org.zstack.zwatch.thirdparty.api.APIUpdateThirdpartyPlatformEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.zwatch.thirdparty.api.APIUpdateThirdpartyPlatformEvent.inventory"
		desc "null"
