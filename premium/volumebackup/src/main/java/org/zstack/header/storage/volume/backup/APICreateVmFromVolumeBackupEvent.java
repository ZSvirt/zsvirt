...
public class APICreateVmFromVolumeBackupEvent extends APIEvent {
    private VmInstanceInventory inventory;

    public APICreateVmFromVolumeBackupEvent(String apiId) {
        super(apiId);
    }

    public APICreateVmFromVolumeBackupEvent() {
        super(null);
    }
    ...
    public static APICreateVmFromVolumeBackupEvent __example__() {
        APICreateVmFromVolumeBackupEvent evt = new APICreateVmFromVolumeBackupEvent();
