...
public class APIStartBaremetalInstanceEvent extends APIEvent {
    private BaremetalInstanceInventory inventory;

    public APIStartBaremetalInstanceEvent() {
    }

    public APIStartBaremetalInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIStartBaremetalInstanceEvent __example__() {
        APIStartBaremetalInstanceEvent event = new APIStartBaremetalInstanceEvent();
