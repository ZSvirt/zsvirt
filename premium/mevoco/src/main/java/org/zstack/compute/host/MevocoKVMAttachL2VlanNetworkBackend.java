 ...
 */
public class MevocoKVMAttachL2VlanNetworkBackend extends MevocoKVMAttachL2NetworkBackend {
    private static final CLogger logger = Utils.getLogger(MevocoKVMAttachL2VlanNetworkBackend.class);
