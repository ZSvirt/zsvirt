...
public class APIChangeIPsecConnectionEvent extends APIEvent {

    private IPsecConnectionInventory inventory;

    public APIChangeIPsecConnectionEvent() {
    }

    public APIChangeIPsecConnectionEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIChangeIPsecConnectionEvent __example__() {
        APIChangeIPsecConnectionEvent event = new APIChangeIPsecConnectionEvent();
