...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.instance.APIStartBaremetalInstanceEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.instance.APIStartBaremetalInstanceEvent.inventory"
		desc "裸机实例清单"
