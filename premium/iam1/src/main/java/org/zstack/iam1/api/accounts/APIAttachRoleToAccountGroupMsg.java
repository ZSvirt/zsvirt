...
@RestRequest(
        ...
        responseClass = APIAttachRoleToAccountGroupEvent.class
)
public class APIAttachRoleToAccountGroupMsg extends APIMessage implements AccountGroupMessage {
    ...
    public static APIAttachRoleToAccountGroupMsg __example__() {
        APIAttachRoleToAccountGroupMsg msg = new APIAttachRoleToAccountGroupMsg();
