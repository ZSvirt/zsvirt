...
public class APIDetachBaremetalPxeServerFromClusterEvent extends APIEvent {
    private BaremetalPxeServerInventory inventory;

    public APIDetachBaremetalPxeServerFromClusterEvent() {
    }

    public APIDetachBaremetalPxeServerFromClusterEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIDetachBaremetalPxeServerFromClusterEvent __example__() {
        APIDetachBaremetalPxeServerFromClusterEvent evt = new APIDetachBaremetalPxeServerFromClusterEvent();
