...
#### 2-е полугодие 2026 года

| Область | Планируемые работы |
|---|---|
| **Безопасность** | Добавить шифрование дисков ВМ<br>Добавить шифрование миграции ВМ |
| **DRS и миграция ВМ** | Добавить более гибкие варианты миграции:<br>• Возможность переносить диски по отдельности<br>• Поддержка горячей и холодной миграции для сценария SAN-to-SAN |
| **ZMigrate** | **ZMigrate 2.1**:<br>• Добавить предварительную проверку для снижения рисков сложной миграции<br>• Более простые и интеллектуальные сценарии миграции |
| **Эксплуатация** | Добавить метрики времени CPU Ready ВМ, задержки чтения и записи дисков ВМ, доли потерянных сетевых пакетов и времени CPU Ready хоста<br>Поддержать более детальные уровни журналирования при пересылке во внешний syslog<br>Добавить мониторинг устройств NVMe и FC, включая IOPS и задержку<br>Встроить драйверы QXL в VMTools для улучшения отображения и разрешения консоли ВМ |
| **Инвентаризация** | Расширить регистрацию хранилищ и ВМ для регистрации в пределах одного сайта |
