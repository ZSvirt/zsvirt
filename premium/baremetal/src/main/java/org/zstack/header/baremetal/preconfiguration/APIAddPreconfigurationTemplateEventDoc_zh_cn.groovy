...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.preconfiguration.APIAddPreconfigurationTemplateEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.preconfiguration.APIAddPreconfigurationTemplateEvent.inventory"
		desc "预配置模板清单"
