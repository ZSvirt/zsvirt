...
public class APIRefreshFiberChannelStorageEvent extends APIEvent {
    ...
    public APIRefreshFiberChannelStorageEvent() {
    }

    public APIRefreshFiberChannelStorageEvent(String apiId) {
        super(apiId);
    }

    public static APIRefreshFiberChannelStorageEvent __example__() {
        APIRefreshFiberChannelStorageEvent evt = new APIRefreshFiberChannelStorageEvent();
        ...
        evt.setInventories(Arrays.asList(fiberChannelStorageInventory1, fiberChannelStorageInventory2));
        evt.setSuccess(true);
        return evt;
    }
}
