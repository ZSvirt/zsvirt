...
public class ImageStoreBackupStorageKvmDownloader extends BackupStorageKvmDownloader {
    @Autowired
    ...
    public final static String DOWNLOAD_BIT_PATH = "/sharedmountpointprimarystorage/imagestore/download";

    public static class DownloadFromImageStoreCmd extends KvmBackend.AgentCmd {
    ...
    public void downloadBits(String bsPath, String psPath, boolean isData, Completion completion) {
        ...
        bus.send(gmsg, new CloudBusCallBack(completion) {
            ...
            public void run(MessageReply reply) {
                ...
                new KvmAgentCommandDispatcher(pinv.getUuid()).go(DOWNLOAD_BIT_PATH, cmd, KvmBackend.AgentRsp.class, new ReturnValueCompletion<KvmBackend.AgentRsp>(completion) {
                    @Override
