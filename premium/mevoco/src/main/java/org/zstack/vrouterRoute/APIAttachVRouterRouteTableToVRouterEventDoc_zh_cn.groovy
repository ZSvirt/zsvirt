...
doc {
	...
	ref {
		name "error"
		path "org.zstack.vrouterRoute.APIAttachVRouterRouteTableToVRouterEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.vrouterRoute.APIAttachVRouterRouteTableToVRouterEvent.inventory"
		desc "null"
