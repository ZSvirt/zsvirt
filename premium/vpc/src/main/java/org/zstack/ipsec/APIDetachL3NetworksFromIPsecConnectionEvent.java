...
public class APIDetachL3NetworksFromIPsecConnectionEvent extends APIEvent {

    private IPsecConnectionInventory inventory;

    public APIDetachL3NetworksFromIPsecConnectionEvent() {
    }

    public APIDetachL3NetworksFromIPsecConnectionEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIDetachL3NetworksFromIPsecConnectionEvent __example__() {
        APIDetachL3NetworksFromIPsecConnectionEvent event = new APIDetachL3NetworksFromIPsecConnectionEvent();
