...
public class APIStartBaremetalPxeServerEvent extends APIEvent {
    private BaremetalPxeServerInventory inventory;

    public APIStartBaremetalPxeServerEvent() {
    }

    public APIStartBaremetalPxeServerEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIStartBaremetalPxeServerEvent __example__() {
        APIStartBaremetalPxeServerEvent evt = new APIStartBaremetalPxeServerEvent();
