...
doc {
	...
	ref {
		name "dns"
		path "org.zstack.header.vpc.VpcRouterVmInventory.dns"
		desc "null"
		type "List"
		since "2.4"
		clz VpcRouterDnsInventory.class
	}
	ref {
		name "haRef"
		path "org.zstack.header.vpc.VpcRouterVmInventory.haRef"
		desc "null"
		type "List"
		since "3.6"
	...
	ref {
		name "vmNics"
		path "org.zstack.header.vpc.VpcRouterVmInventory.vmNics"
		desc "null"
		type "List"
		since "0.6"
	...
	ref {
		name "allVolumes"
		path "org.zstack.header.vpc.VpcRouterVmInventory.allVolumes"
		desc "null"
		type "List"
		since "0.6"
	...
	ref {
		name "vmCdRoms"
		path "org.zstack.header.vpc.VpcRouterVmInventory.vmCdRoms"
		desc "null"
		type "List"
		since "0.6"
