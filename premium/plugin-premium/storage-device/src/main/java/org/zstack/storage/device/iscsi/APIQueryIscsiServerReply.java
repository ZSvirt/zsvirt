...
public class APIQueryIscsiServerReply extends APIQueryReply {
    private List<IscsiServerInventory> inventories;

    public List<IscsiServerInventory> getInventories() {
        return inventories;
    }

    public void setInventories(List<IscsiServerInventory> inventories) {
        this.inventories = inventories;
    }

    public static APIQueryIscsiServerReply __example__() {
        APIQueryIscsiServerReply reply = new APIQueryIscsiServerReply();
        ...
        reply.setInventories(asList(iscsiServerInventory));
