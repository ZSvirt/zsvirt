...
@RestRequest(
        ...
        isAction = true,
        responseClass = APIRevokeResourceSharingToGroupEvent.class
)
public class APIRevokeResourceSharingToGroupMsg extends APIMessage implements AccountGroupMessage {
    ...
    public static APIRevokeResourceSharingToGroupMsg __example__() {
        APIRevokeResourceSharingToGroupMsg msg = new APIRevokeResourceSharingToGroupMsg();
