...
public class APIAttachNvmeServerToClusterEvent extends APIEvent {
    ...
    public APIAttachNvmeServerToClusterEvent(String apiId) {
        super(apiId);
    }

    public APIAttachNvmeServerToClusterEvent() {
        super(null);
    }

    public static APIAttachNvmeServerToClusterEvent __example__() {
        APIAttachNvmeServerToClusterEvent event = new APIAttachNvmeServerToClusterEvent();
