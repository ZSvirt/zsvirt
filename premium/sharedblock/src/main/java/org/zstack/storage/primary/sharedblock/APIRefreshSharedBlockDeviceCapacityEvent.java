...
public class APIRefreshSharedBlockDeviceCapacityEvent extends APIEvent {
    ...
    public APIRefreshSharedBlockDeviceCapacityEvent() {
    }

    public APIRefreshSharedBlockDeviceCapacityEvent(String apiId) {
        super(apiId);
    }

    public static APIRefreshSharedBlockDeviceCapacityEvent __example__() {
        APIRefreshSharedBlockDeviceCapacityEvent event = new APIRefreshSharedBlockDeviceCapacityEvent();
