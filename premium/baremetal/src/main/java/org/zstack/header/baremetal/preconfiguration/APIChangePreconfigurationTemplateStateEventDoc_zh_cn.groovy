...
doc {
	...
	ref {
		name "error"
		path "org.zstack.header.baremetal.preconfiguration.APIChangePreconfigurationTemplateStateEvent.error"
	...
	ref {
		name "inventory"
		path "org.zstack.header.baremetal.preconfiguration.APIChangePreconfigurationTemplateStateEvent.inventory"
		desc "预配置模板清单"
