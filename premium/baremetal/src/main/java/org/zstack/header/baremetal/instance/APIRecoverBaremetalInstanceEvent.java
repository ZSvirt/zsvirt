...
public class APIRecoverBaremetalInstanceEvent extends APIEvent {
    private BaremetalInstanceInventory inventory;

    public APIRecoverBaremetalInstanceEvent() {
    }

    public APIRecoverBaremetalInstanceEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIRecoverBaremetalInstanceEvent __example__() {
        APIRecoverBaremetalInstanceEvent event = new APIRecoverBaremetalInstanceEvent();
