...
@RestRequest(
        ...
        responseClass = APIRebootBaremetalInstanceEvent.class
)
public class APIRebootBaremetalInstanceMsg extends APIMessage implements BaremetalInstanceMessage {
    ...
    public static APIRebootBaremetalInstanceMsg __example__() {
        APIRebootBaremetalInstanceMsg msg = new APIRebootBaremetalInstanceMsg();
        msg.setUuid(uuid());
        return msg;
    }
}
