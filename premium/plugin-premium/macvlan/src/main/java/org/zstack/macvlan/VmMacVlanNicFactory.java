...
public class VmMacVlanNicFactory implements VmInstanceNicFactory {

    private static final CLogger logger = Utils.getLogger(VmMacVlanNicFactory.class);
    private static final VmNicType type = new VmNicType(VmMacVlanNicConstant.MACVLAN_NIC_TYPE);
    private static final VSwitchType vSwitchType = new VSwitchType(L2NetworkConstant.VSWITCH_TYPE_MACVLAN, type);
