...
public class CountMetric extends Metric {
    protected CountMetric(String name, Enum... labelNames) {
        super(name, Unit.COUNT, labelNames);
    }

    public CountMetric(String name, Collection collection, boolean adminOnly, Enum... labelNames) {
        this(name, collection, labelNames);
        this.adminOnly = adminOnly;
    }

    public CountMetric(String name, Collection collection, Enum... labelNames) {
