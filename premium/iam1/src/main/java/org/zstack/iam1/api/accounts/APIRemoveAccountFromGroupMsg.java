...
@RestRequest(
        ...
        responseClass = APIRemoveAccountFromGroupEvent.class
)
public class APIRemoveAccountFromGroupMsg extends APIMessage implements AccountGroupMessage {
    ...
    public static APIRemoveAccountFromGroupMsg __example__() {
        APIRemoveAccountFromGroupMsg msg = new APIRemoveAccountFromGroupMsg();
