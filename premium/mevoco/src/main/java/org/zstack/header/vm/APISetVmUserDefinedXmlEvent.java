...
public class APISetVmUserDefinedXmlEvent extends APIEvent {
    private String vmUserDefinedXml;

    public String getVmUserDefinedXml() {
        return vmUserDefinedXml;
    }

    public void setVmUserDefinedXml(String vmUserDefinedXml) {
        this.vmUserDefinedXml = vmUserDefinedXml;
    }

    public APISetVmUserDefinedXmlEvent() {
    }

    public APISetVmUserDefinedXmlEvent(String apiId) {
        super(apiId);
    }

    public static APISetVmUserDefinedXmlEvent __example__() {
        APISetVmUserDefinedXmlEvent evt = new APISetVmUserDefinedXmlEvent();

        evt.vmUserDefinedXml = "<domain type='kvm' id='1' xmlns:qemu='http://libvirt.org/schemas/domain/qemu/1.0'>\n" +
