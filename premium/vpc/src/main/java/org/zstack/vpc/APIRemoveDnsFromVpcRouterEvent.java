...
public class APIRemoveDnsFromVpcRouterEvent extends APIEvent {
    /**
     * @desc see :ref:`VpcRouterVmInventory`
     */
    private VpcRouterVmInventory inventory;

    public APIRemoveDnsFromVpcRouterEvent() {
        super(null);
    }

    public APIRemoveDnsFromVpcRouterEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIRemoveDnsFromVpcRouterEvent __example__() {
        APIRemoveDnsFromVpcRouterEvent event = new APIRemoveDnsFromVpcRouterEvent();
