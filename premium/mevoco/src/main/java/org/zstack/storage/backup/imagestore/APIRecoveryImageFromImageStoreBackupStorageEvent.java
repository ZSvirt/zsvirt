...
public class APIRecoveryImageFromImageStoreBackupStorageEvent extends APIEvent {
    ...
    public APIRecoveryImageFromImageStoreBackupStorageEvent(String apiId) {
        super(apiId);
    }

    public APIRecoveryImageFromImageStoreBackupStorageEvent() {
        super(null);
    }

    public static APIRecoveryImageFromImageStoreBackupStorageEvent __example__() {
        APIRecoveryImageFromImageStoreBackupStorageEvent event = new APIRecoveryImageFromImageStoreBackupStorageEvent();
