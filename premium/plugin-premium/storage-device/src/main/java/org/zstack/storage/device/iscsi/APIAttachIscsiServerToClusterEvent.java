...
public class APIAttachIscsiServerToClusterEvent extends APIEvent {
    ...
    public APIAttachIscsiServerToClusterEvent(String apiId) {
        super(apiId);
    }

    public APIAttachIscsiServerToClusterEvent() {
        super(null);
    }

    public static APIAttachIscsiServerToClusterEvent __example__() {
        APIAttachIscsiServerToClusterEvent event = new APIAttachIscsiServerToClusterEvent();
