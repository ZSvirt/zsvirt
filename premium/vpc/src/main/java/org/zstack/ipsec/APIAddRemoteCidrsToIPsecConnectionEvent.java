...
public class APIAddRemoteCidrsToIPsecConnectionEvent extends APIEvent {

    private IPsecConnectionInventory inventory;

    public APIAddRemoteCidrsToIPsecConnectionEvent() {
    }

    public APIAddRemoteCidrsToIPsecConnectionEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIAddRemoteCidrsToIPsecConnectionEvent __example__() {
        APIAddRemoteCidrsToIPsecConnectionEvent event = new APIAddRemoteCidrsToIPsecConnectionEvent();
