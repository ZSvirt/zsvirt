 ...
 */
public class CountRateMetric extends Metric {
    protected CountRateMetric(String name, Enum... labelNames) {
        super(name, Unit.COUNT, labelNames);
    }

    public CountRateMetric(String name, Collection collection, boolean adminOnly, Enum... labelNames) {
        this(name, collection, labelNames);
        this.adminOnly = adminOnly;
    }

    public CountRateMetric(String name, Collection collection, Enum... labelNames) {
