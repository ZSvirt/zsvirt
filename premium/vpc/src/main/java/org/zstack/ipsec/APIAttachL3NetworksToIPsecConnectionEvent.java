...
public class APIAttachL3NetworksToIPsecConnectionEvent extends APIEvent {

    private IPsecConnectionInventory inventory;

    public APIAttachL3NetworksToIPsecConnectionEvent() {
    }

    public APIAttachL3NetworksToIPsecConnectionEvent(String apiId) {
        super(apiId);
    }
    ...
    public static APIAttachL3NetworksToIPsecConnectionEvent __example__() {
        APIAttachL3NetworksToIPsecConnectionEvent event = new APIAttachL3NetworksToIPsecConnectionEvent();
